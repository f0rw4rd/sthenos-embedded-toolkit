...
source "$SCRIPT_DIR/../lib/common.sh"        # Core functions: setup_arch, download_source, etc.
source "$SCRIPT_DIR/../lib/build_flags.sh"   # Architecture-specific compiler flags
source "$SCRIPT_DIR/../lib/build_helpers.sh"  # Build utilities: standard_configure, install_binary, etc.
