...
SUPPORTED_OS="linux,android,freebsd,openbsd,netbsd"  # macOS: Zig Darwin shim lacks net/bpf.h
...
build_tcpdump() {
    ...
    # Tell tcpdump's autoconf that our bundled libpcap 1.10.4 provides these
    # functions — otherwise it links its own missing/*.o compatibility shims,
    # which collide with libpcap.a on BSDs (duplicate-symbol link errors).
    ...
    ac_cv_func_pcap_datalink_val_to_description_or_dlt=yes \
